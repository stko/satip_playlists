...
class WebService {
  ...
  constructor() {
    ...
    this.SIGNALING_SERVER = ws_protocol + window.location.hostname + ":" + window.location.port + "/ws"
...
window.onload = function () {
  const user_id = Math.random().toString(36).substring(2, 10 + 2);
  messenger.init(user_id, "mypw", { "somesettings": "anything" })
};
